declare module 'amf-js/src/Clojure' {
	export class Clojure {
	    static kw(s: string): any;
	    static cljsToJs(o: any): any;
	    static jsToCljs(o: any): any;
	    static cljsMap<T>(xs: any, f: (x: any) => T): T[];
	    static toCljsSeq(xs: any[]): any;
	    static core: any;
	    static amf: any;
	    static amf_document: any;
	    static amf_domain: any;
	}

}
declare module 'amf-js/src/core/Model' {
	/**
	 * Base class for all AMF parsed models, provides methods to inspect and manipulate the model
	 */
	export abstract class Model {
	    protected rawModel: any;
	    /**
	     * Builds the model from the inner Clojure data structure generated by the AMF library
	     * @param rawModel
	     */
	    constructor(rawModel: any);
	    /**
	     * Returns the raw Clojure data structure for this instance data
	     * @return
	     */
	    abstract clojureModel(): any;
	    /**
...
declare module 'amf-js/src/core/domain/GenericParameter' {
	/**
	...
	export abstract class GenericParameter extends DomainModel {
	    ...
	    setParameterKindInternal(parameterKind: ParameterKind): void;
	}

}
declare module 'amf-js/src/core/domain/Header' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { GenericParameter } from 'amf-js/src/core/domain/GenericParameter';
	/**
	 * Parameter representing a HTTP header
	 */
	export class Header extends GenericParameter {
	    constructor(rawModel: any);
	    static build(id: string): Header;
	}

}
declare module 'amf-js/src/core/domain/shapes/PropertyShape' {
	/**
	 * Created by antoniogarrote on 10/05/2017.
	 */
	import { Shape, XSDDataType } from 'amf-js/src/core/domain/shapes/Shape';
	export class PropertyShape extends Shape {
	    getPath(): string | undefined;
	    setPath(path: string | null): void;
	    getPropertyLabel(): string | undefined;
	    setPropertyLabel(label: string | null): void;
	    getMinCount(): number | undefined;
	    setMinCount(count: number | null): void;
	    getMaxCount(): number | undefined;
	    setMaxCount(count: number | null): void;
	    getDatatype(): XSDDataType | undefined;
	    setDatatype(type: XSDDataType | null): void;
	    getNode(): Shape | undefined;
	    setNode(object: Shape | null): void;
	    getOrdered(): boolean;
	    setOrdered(ordered: boolean | null): void;
	    static build(id: string): PropertyShape;
	}

}
declare module 'amf-js/src/core/domain/shapes/NodeShape' {
	/**
	 * Created by antoniogarrote on 10/05/2017.
	 */
	import { Shape } from 'amf-js/src/core/domain/shapes/Shape';
	import { PropertyShape } from 'amf-js/src/core/domain/shapes/PropertyShape';
	export class NodeShape extends Shape {
	    getPropertyShapes(): PropertyShape[];
	    getClosed(): boolean;
	    setClosed(closed: boolean): void;
	    static build(id: string): NodeShape;
	}

}
declare module 'amf-js/src/core/domain/shapes/ScalarShape' {
	/**
	 * Created by antoniogarrote on 10/05/2017.
	 */
	import { Shape, XSDDataType } from 'amf-js/src/core/domain/shapes/Shape';
	export class ScalarShape extends Shape {
	    getDatatype(): XSDDataType | undefined;
	    setDatatype(type: XSDDataType | null): void;
	    static build(id: string): ScalarShape;
	}

}
declare module 'amf-js/src/core/domain/shapes/ArrayShape' {
	/**
	 * Created by antoniogarrote on 10/05/2017.
	 */
	import { Shape } from 'amf-js/src/core/domain/shapes/Shape';
	export class ArrayShape extends Shape {
	    ...
	    static build(id: string): ArrayShape;
	}

}
declare module 'amf-js/src/core/domain/shapes/FileUploadShape' {
	/**
	 * Created by antoniogarrote on 10/05/2017.
	 */
	import { Shape } from 'amf-js/src/core/domain/shapes/Shape';
	export class FileUploadShape extends Shape {
	    ...
	    setSchemaRaw(fileTypes: string[] | null): void;
	    static build(id: string): FileUploadShape;
	}

}
declare module 'amf-js/src/core/domain/shapes/XMLSchemaShape' {
	/**
	 * Created by antoniogarrote on 10/05/2017.
	 */
	import { Shape } from 'amf-js/src/core/domain/shapes/Shape';
	export class XMLSchemaShape extends Shape {
	    getSchemaRaw(): string | undefined;
	    setSchemaRaw(schema: string | null): void;
	    static build(id: string): XMLSchemaShape;
	}

}
declare module 'amf-js/src/core/domain/shapes/JSONSchemaShape' {
	/**
	 * Created by antoniogarrote on 10/05/2017.
	 */
	import { Shape } from 'amf-js/src/core/domain/shapes/Shape';
	export class JSONSchemaShape extends Shape {
	    getSchemaRaw(): string | undefined;
	    setSchemaRaw(schema: string | null): void;
	    static build(id: string): JSONSchemaShape;
	}

}
declare module 'amf-js/src/core/domain/shapes/Shape' {
	/**
	 * Created by antoniogarrote on 10/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	...
	export class Shape extends DomainModel {
	    getId(): string;
	    getInherits(): Shape[];
	    setInherits(shapes: Shape[]): void;
	    static build(id: string): Shape;
	    static fromRawModel(rawModel: any): Shape;
	    protected static findShapeClass(shape: any, shapeClass: string): boolean;
	    protected getValue<T>(p: any): T | undefined;
	    protected getValues<T>(p: any): T[] | undefined;
	    protected setValue(p: string, x: any): void;
	    protected setValues(p: string, x: any): void;
	    protected setRdfObject(p: string, object: any | null): void;
	    protected getRdfObject(p: any): any | undefined;
	    protected getRdfObjects(p: any): any[] | undefined;
	    protected getRdfId(p: any): string | undefined;
	    protected setRdfId(p: string, id: string | null): void;
	    protected static ensureArray(x: any): any[];
	}

}
declare module 'amf-js/src/core/domain/Type' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	...
	export class Type extends DomainModel {
	     ...
	     * @return
	     */
	    getJSONLDShape(): JSONLD | undefined;
	    /**
	     * Sets the SHACL shape for the payloads of this operation unit
	     * @param shaclShape valid SHACL shape encoded as JSON-LD string
	     */
	    setJSONLDShape(shape: JSONLD | undefined): void;
	    /**
	     * Shape object for this type
	     * @returns {Shape}
	     */
	    getShape(): Shape | undefined;
	    setShape(shape: Shape | undefined): void;
	    static build(id: string): Type;
	}

}
declare module 'amf-js/src/core/domain/Payload' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	...
	export class Payload extends DomainModel {
	    ...
	    setMediaType(mediaType: string | undefined): void;
	    /**
	     * Schema information for the payload
	     * @return
	     */
	    getSchema(): Type | undefined;
	    setSchema(schema: Type | undefined): void;
	    static build(id: string): Payload;
	}

}
declare module 'amf-js/src/core/domain/GenericOperationUnit' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	import { Header } from 'amf-js/src/core/domain/Header';
	import { Payload } from 'amf-js/src/core/domain/Payload';
	/**
...
declare module 'amf-js/src/core/domain/Parameter' {
	import { GenericParameter, ParameterKind } from 'amf-js/src/core/domain/GenericParameter';
	/**
	...
	export class Parameter extends GenericParameter {
	    static build(id: string, parameterKind: ParameterKind): Parameter;
	}

}
declare module 'amf-js/src/core/domain/Request' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { GenericOperationUnit } from 'amf-js/src/core/domain/GenericOperationUnit';
	import { Parameter } from 'amf-js/src/core/domain/Parameter';
	/**
	...
	export class Request extends GenericOperationUnit {
	    ...
	    static build(id: string): Request;
	}

}
declare module 'amf-js/src/core/domain/Response' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { GenericOperationUnit } from 'amf-js/src/core/domain/GenericOperationUnit';
	...
	export class Response extends GenericOperationUnit {
	    ...
	    setStatusCode(statusCode: string | undefined): void;
	    static build(id: string): Response;
	}

}
declare module 'amf-js/src/core/domain/Operation' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	import { Request } from 'amf-js/src/core/domain/Request';
	import { Response } from 'amf-js/src/core/domain/Response';
	/**
	...
	export class Operation extends DomainModel {
	     ...
	     * @param id
	     */
	    static build(id: string): Operation;
	}

}
declare module 'amf-js/src/core/domain/EndPoint' {
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	import { Operation } from 'amf-js/src/core/domain/Operation';
	/**
	...
	export class EndPoint extends DomainModel {
	     ...
	     */
	    getPath(): string | undefined;
	    setPath(basePath: string | undefined): void;
	    /**
	     * List of API Operations bound to this EndPoint
	     * @return
	     */
	    getSupportedOperations(): Operation[];
	    setSupportedOperations(operations: Operation[]): void;
	    /**
	     * Builds a new EndPoint for the provided URI
	     * @param id
	     */
	    static build(id: string): EndPoint;
	}

}
declare module 'amf-js/src/core/domain/APIDocumentation' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	import { EndPoint } from 'amf-js/src/core/domain/EndPoint';
	import { Parameter } from 'amf-js/src/core/domain/Parameter';
	import { Header } from 'amf-js/src/core/domain/Header';
	/**
	...
	export class APIDocumentation extends DomainModel {
	    ...
	    setTermsOfService(termsOfService: string | undefined): void;
	    getBasePath(): string | undefined;
	    setBasePath(basePath: string | undefined): void;
	     ...
	     * @param id
	     */
	    static build(id: string): APIDocumentation;
	}

}
declare module 'amf-js/src/core/domain/GenericTag' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	...
	export class GenericTag extends DomainModel {
	    ...
	    static build(id: string, value: string, tagId?: string): GenericTag;
	}

}
declare module 'amf-js/src/core/domain/SourceMap' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
	import { GenericTag } from 'amf-js/src/core/domain/GenericTag';
	/**
	...
	export class SourceMap extends DomainModel {
	     ...
	     */
	    getTags(): GenericTag[];
	    setTags(tags: GenericTag[]): void;
	    static build(id: string): SourceMap;
	}

}
declare module 'amf-js/src/core/domain/DomainModel' {
	import { Model } from 'amf-js/src/core/Model';
	/**
	...
	export class DomainModel extends Model {
	     ...
	     */
	    static fromRawModel(rawModel: any): DomainModel;
	    clojureModel(): any;
	    /**
	     ...
	     * @return
	     */
	    getAbstract(): boolean | undefined;
	    setAbstract(abstract: boolean | undefined): void;
	    /**
	     * List of Domain Elements this element extends
	     * @return
	     */
	    getExtends(): DomainModel[];
	    setExtensions(extensions: DomainModel[]): void;
	    /**
	     * Optional list of source maps with lexical information associated to the Domain Element
	     * @return
	     */
	    getSourceMaps(): SourceMap[];
	    setSourceMaps(sourceMaps: SourceMap[]): void;
	    static domain_builder: any;
	}
	import { SourceMap } from 'amf-js/src/core/domain/SourceMap';

}
declare module 'amf-js/src/core/document/EncodesDomainModel' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
...
declare module 'amf-js/src/core/document/DeclaresDomainModel' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DomainModel } from 'amf-js/src/core/domain/DomainModel';
...
declare module 'amf-js/src/core/document/Document' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DocumentModel } from 'amf-js/src/core/document/DocumentModel';
	import { EncodesDomainModel } from 'amf-js/src/core/document/EncodesDomainModel';
	import { DeclaresDomainModel } from 'amf-js/src/core/document/DeclaresDomainModel';
	/**
...
declare module 'amf-js/src/core/document/Module' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	/**
...
declare module 'amf-js/src/core/document/Fragment' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	/**
...
declare module 'amf-js/src/core/document/DocumentModel' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { Model } from 'amf-js/src/core/Model';
	...
	export class DocumentModel extends Model {
	    ...
	    constructor(rawModel: any);
	    isResolved(): boolean;
	    protected setResolved(isResolved: boolean): void;
	    /**
	     * Builds a new Model object for the referenced Document
	     * @param reference
	     * @return
	     */
	    modelForReference(reference: URL): DocumentModel;
	    /**
...
declare module 'amf-js/src/parsers/ParsingOptions' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	/**
...
declare module 'amf-js/src/parsers/BaseParser' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DocumentModel } from 'amf-js/src/core/document/DocumentModel';
	import { URL } from 'amf-js/index';
	import { ParsingOptions } from 'amf-js/src/parsers/ParsingOptions';
	/**
	...
	export abstract class BaseParser {
	     ...
	     */
	    parseFile(url: URL, options: ParsingOptions, cb: (err?: Error, model?: DocumentModel) => void): void;
	    /**
	     ...
	     * @return The parsed Model
	     */
	    parseString(text: string, url: URL, options: ParsingOptions, cb: (err?: Error, model?: DocumentModel) => void): void;
	    protected abstract parser(): any;
	}

}
declare module 'amf-js/src/parsers/RAMLParser' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { BaseParser } from 'amf-js/src/parsers/BaseParser';
	/**
...
declare module 'amf-js/src/parsers/OpenAPIParser' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { BaseParser } from 'amf-js/src/parsers/BaseParser';
...
declare module 'amf-js/src/parsers/AMFJSONLDParser' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { BaseParser } from 'amf-js/src/parsers/BaseParser';
...
declare module 'amf-js/src/generators/GenerationOptions' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	/**
...
declare module 'amf-js/src/generators/BaseGenerator' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { DocumentModel } from 'amf-js/src/core/document/DocumentModel';
	import { GenerationOptions } from 'amf-js/src/generators/GenerationOptions';
	/**
	...
	export abstract class BaseGenerator {
	     ...
	     */
	    generateFile(model: DocumentModel, path: string, options: GenerationOptions, cb: (e?: Error) => void): void;
	    /**
	     ...
	     * the generated text
	     */
	    generateString(model: DocumentModel, path: string | null, options: GenerationOptions, cb: (e?: Error, text?: string) => void): void;
	    protected abstract generator(): any;
	}

}
declare module 'amf-js/src/generators/RAMLGenerator' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { BaseGenerator } from 'amf-js/src/generators/BaseGenerator';
	/**
...
declare module 'amf-js/src/generators/OpenAPIGenerator' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { BaseGenerator } from 'amf-js/src/generators/BaseGenerator';
...
declare module 'amf-js/src/generators/AMFJSONLDGenerator' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { BaseGenerator } from 'amf-js/src/generators/BaseGenerator';
...
declare module 'amf-js/index' {
	/**
	 * Created by antoniogarrote on 05/05/2017.
	 */
	import { RAMLParser } from 'amf-js/src/parsers/RAMLParser';
	import { OpenAPIParser } from 'amf-js/src/parsers/OpenAPIParser';
	import { AMFJSONLDParser } from 'amf-js/src/parsers/AMFJSONLDParser';
	import { RAMLGenerator } from 'amf-js/src/generators/RAMLGenerator';
	import { OpenAPIGenerator } from 'amf-js/src/generators/OpenAPIGenerator';
	import { AMFJSONDGenerator } from 'amf-js/src/generators/AMFJSONLDGenerator';
	import { Model } from 'amf-js/src/core/Model';
	import { DocumentModel } from 'amf-js/src/core/document/DocumentModel';
	import { Fragment } from 'amf-js/src/core/document/Fragment';
	import { Module } from 'amf-js/src/core/document/Module';
	import { Document } from 'amf-js/src/core/document/Document';
	import { ArrayShape } from 'amf-js/src/core/domain/shapes/ArrayShape';
	import { FileUploadShape } from 'amf-js/src/core/domain/shapes/FileUploadShape';
	import { JSONSchemaShape } from 'amf-js/src/core/domain/shapes/JSONSchemaShape';
	import { NodeShape } from 'amf-js/src/core/domain/shapes/NodeShape';
	import { PropertyShape } from 'amf-js/src/core/domain/shapes/PropertyShape';
	import { ScalarShape } from 'amf-js/src/core/domain/shapes/ScalarShape';
	import { Shape } from 'amf-js/src/core/domain/shapes/Shape';
	import { XMLSchemaShape } from 'amf-js/src/core/domain/shapes/XMLSchemaShape';
	import { APIDocumentation } from 'amf-js/src/core/domain/APIDocumentation';
	import { EndPoint } from 'amf-js/src/core/domain/EndPoint';
	import { GenericOperationUnit } from 'amf-js/src/core/domain/GenericOperationUnit';
	import { GenericParameter } from 'amf-js/src/core/domain/GenericParameter';
	import { GenericTag } from 'amf-js/src/core/domain/GenericTag';
	...
	export const core: {
	    ...
	    domain: {
	        shapes: {
	            ...
	            FileUploadShape: typeof FileUploadShape;
	            JSONSchemaShape: typeof JSONSchemaShape;
	            NodeShape: typeof NodeShape;
	            PropertyShape: typeof PropertyShape;
	            ScalarShape: typeof ScalarShape;
	            Shape: typeof Shape;
	            XMLSchemaShape: typeof XMLSchemaShape;
	        };
	        APIDocumentation: typeof APIDocumentation;
	        EndPoint: typeof EndPoint;
	        GenericOperationUnit: typeof GenericOperationUnit;
	        GenericParametet: typeof GenericParameter;
	        GenericTag: typeof GenericTag;
	...
	export class AMF {
	     ...
	     * @return
	     */
	    static OpenAPIParser: OpenAPIParser;
	    /**
	     * Builds a AMF encoded JSON-LD to AMF parser
	     * @return
	     */
	    static JSONLDParser: AMFJSONLDParser;
	    /**
	     * Builds a AMF to RAML generator
	     * @return
	     */
	    static RAMLGenerator: RAMLGenerator;
	    /**
	     * Builds a AMF to OpenAPI generator
	     * @return
	     */
	    static OpenAPIGenerator: OpenAPIGenerator;
	    /**
	     * Builds a AMF to JSON-LD generator
	     * @return
	     */
	    static JSONLDGenerator: AMFJSONDGenerator;
	}

}
// Generated by typings
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/a4a912a0cd1849fa7df0e5d909c8625fba04e49d/node/index.d.ts
interface Console {
