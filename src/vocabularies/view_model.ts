  ...
  public constructor (public editor: any) {
    ...
    this.selectedFormat.subscribe((format) => {
      ...
      if (format === 'jsonld') {
        ...
        if (this.selectedReference().kind === 'vocabulary') { this.query.predefinedQueries(this.vocabularyPredefinedQueries) }
        if (this.selectedReference().kind === 'dialect') { this.query.predefinedQueries(this.dialectPredefinedQueries) }
        if (this.selectedReference().kind === 'document') { this.query.predefinedQueries(this.documentPredefinedQueries) }
